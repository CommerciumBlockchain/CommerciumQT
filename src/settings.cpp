...
void Settings::setUsingCommerciumConf(QString confLocation) {
...
bool Settings::addToCommerciumConf(QString confLocation, QString line) {
...
bool Settings::removeFromCommerciumConf(QString confLocation, QString option) {
